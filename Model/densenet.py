...
class wide(nn.Module):
    def __init__(self, in_channels):
        ...
        self.conv1 = nn.Conv2d(in_channels, 512, kernel_size=(256,3), padding=0)
        self.conv1_bn = nn.BatchNorm2d(512)
    def forward(self, x):
        conv1_out = F.relu(self.conv1_bn(self.conv1(x)))
        out = F.max_pool2d(conv1_out, kernel_size=(1,3), stride=3,ceil_mode=True)
        return conv1_out
